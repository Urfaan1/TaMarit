...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 h-screen sticky top-0 left-0 bg-white border-r border-gray-100 flex flex-col justify-between py-6 px-4 shadow-[2px_0_10px_rgba(0,0,0,0.02)] z-40">
